...
const CardDeck = () => {
  const initialDeck = [
    diamonds2, diamonds3, diamonds4, diamonds5, diamonds6,
    clubs2, clubs3, clubs4, clubs5, clubs6, clubs7, clubs8, clubs9, clubs10, clubsAce, clubsJack, clubsKing, clubsQueen,
    diamondsAce, diamondsJack, diamondsKing, diamondsQueen,
    hearts2, hearts3, hearts4, hearts5, hearts6, hearts7, hearts8, hearts9, hearts10, heartsAce, heartsJack, heartsKing, heartsQueen,
